...
/*global $, PAPAYA_VIEWER_CSS, PAPAYA_DEFAULT_TOOLBAR_ID, PAPAYA_DEFAULT_VIEWER_ID, PAPAYA_DEFAULT_DISPLAY_ID,
 ...
 PAPAYA_CONTROL_SWAP_BUTTON_CSS, PAPAYA_CONTROL_DIRECTION_SLIDER, PAPAYA_CONTROL_MAIN_SLIDER, PAPAYA_MARKER_LABEL_ID, PAPAYA_LABEL_DIALOG_CSS,
...
papaya.Container.fillContainerHTML = function (containerHTML, isDefault, params, replaceIndex) {
    ...
    if (isDefault) {
        ...
        /*containerHTML.append("<div id='" + (PAPAYA_MARKER_LABEL_ID + index) +
            "' class='" + PAPAYA_LABEL_DIALOG_CSS + "' title='Add label'></div>");*/
